...
export const Item = ({
  ...
  return (
    <div
      ...
      className={cn(
        "group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center" +
    ...
    >
      {!!id && (
        <div
          role={"button"}
          className="h-full rounded-sm hover:bg-neutral-300 dark:bg-neutral-600/5 mr-1"
      ...
      {!!id && (
        <div className="ml-auto flex items-center gap-x-2">
          ...
          >
            <Plus className="h4 w4 text-muted-foreground" />
          </div>
        </div>
      )}
    </div>
